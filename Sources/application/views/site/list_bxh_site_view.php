                ...
                <ul class="w3-ul w3-hoverable w3-white">
                    ...
                    foreach ($listdlbxhtop6 as $row){?>
                        <li class="w3-padding-16">
                            <img src="<?php echo base_url() . "assets/img/dddl/". $row['link_dddl'];?>" alt="Jane" style="width:100%" class="w3-grayscale">
                            <div class="w3-container w3-black">
                                <a href="<?php echo base_url(). "index.php/dich_vu/view_detail/" . $row['id_dddl'];?>">
            ...
            <div class="w3-white w3-margin">
                ...
                <ul class="w3-ul w3-hoverable w3-white">
                    ...
                    foreach ($listdvbxhtop6 as $row){?>
                        <li class="w3-padding-16">
                            <img src="<?php echo base_url() . "assets/img/dv/". $row['link_dv'];?>" alt="Jane" style="width:100%" class="w3-grayscale">
                            <div class="w3-container w3-black">
