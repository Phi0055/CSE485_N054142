<div id="nt-compact">
    <ul>
        ...
        <li><a class="btn" href="<?php echo base_url();?>index.php/du_lich"><i class="fa fa-heart"></i><div class="nt-tooltip"><p style="font-family:'Ubuntu Condensed', sans-serif;">DuLịch</p></div></a></li>
        ...
        if ($this->session->userdata("CheckLogin")){?>
            <li><a class="btn" href="<?php echo base_url() . "index.php/ttcn/index/" . $this->session->userdata("id_tk");?>" title="settings"><i class="fa fa-cogs"></i><div class="nt-tooltip"><p style="font-family:'Ubuntu Condensed', sans-serif;">Settings</p></div></a></li>
