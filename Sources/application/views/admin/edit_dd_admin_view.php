<div class="content">
    ...
    <form method="post" action="<?php echo base_url() . 'index.php/admin/pro_edit_dd/' . $dd['id_dd'];?>">
        <div class="form">
            <table class="table">
                <tr>
                    <td><P>Tên</p></td>
                ...
                <tr>
                    <td><P>Hình ảnh</p></td>
                    <td><input type="text" name="link" class="form-control" value="<?php echo $dd['link_dd'];?>"></td>
                </tr>
                <tr>
